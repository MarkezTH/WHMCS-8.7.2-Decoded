...
class AuthenticationConfirmation extends Authentication
{
    ...
    public function authenticationConfirmation(\WHMCS\Http\Message\ServerRequest $request)
    {
        ...
        return (new \WHMCS\Admin\ApplicationSupport\View\Html\Smarty\TemplateBody("authconfirm"))->setTitle("Admin Authentication")->setTemplateVariables(["incorrect" => $request->request()->has("authconfirm"), "post_fields" => $repostFields]);
    }
