...
class SortableTable
{
    ...
    protected $jqueryCode = [];
    protected $rowsOfData = 0;
    protected $request = NULL;
    protected static $tables = [];
    protected static $sortData = [];
    ...
    public function storeUserSortData($data = [])
    {
    ...
    public function getHtml($columns, $tableData, $formUrl = "", $formButtons = "", $topButtons = "")
    {
        ...
        if (!$rowsOfData) {
            ...
            $page = $this->getPage();
            if ($page) {
                $tableDataRange = ["start" => $page * $this->getRowLimit(), "end" => $page * $this->getRowLimit() + $this->getRowLimit()];
            } else {
                $tableDataRange = ["start" => 0, "end" => $this->getRowLimit()];
            }
    ...
    protected function getHiddenInputHtml()
    {
        ...
        foreach (["orderby", "page", "PHPSESSID", "token", "table", "rp", "tab"] as $nonPropagatingParam) {
