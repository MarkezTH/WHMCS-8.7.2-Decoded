...
class SyncItem
{
    ...
    public function __construct($moduleValues, $uniqueIdField, $servicesCollection, $productField)
    {
    ...
    public function getMatches()
    {
        ...
        foreach ($this->getServices() as $service) {
            ...
            if (in_array($service->getStatus(), [\WHMCS\Service\Status::CANCELLED, \WHMCS\Service\Status::TERMINATED])) {
                $rank = 0;
            }
