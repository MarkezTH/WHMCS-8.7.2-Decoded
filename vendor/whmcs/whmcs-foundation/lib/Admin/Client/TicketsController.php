...
class TicketsController
{
    public function tickets(\WHMCS\Http\Message\ServerRequest $request)
    {
        ...
        $aInt->content = view("admin.client.profile.tickets", ["csrfToken" => $csrfToken, "tickets" => $tickets, "userId" => $userId, "ticketCounts" => ["thisMonth" => $tickets->filter(function (\WHMCS\Support\Ticket $value) use($endOfLastMonth) {
