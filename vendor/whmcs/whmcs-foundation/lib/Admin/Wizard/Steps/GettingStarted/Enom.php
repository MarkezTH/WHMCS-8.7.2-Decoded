...
class Enom
{
    ...
    public function getTemplateVariables()
    {
        ...
        $vars = ["BASE_PATH_IMG" => $assetHelper->getImgPath(), "BASE_PATH_JS" => $assetHelper->getJsPath(), "clientCountries" => (new \WHMCS\Utility\Country())->getCountryNameArray(), "defaultCountry" => \WHMCS\Config\Setting::getValue("DefaultCountry"), "phoneNumberInputStyle" => (int) \WHMCS\Config\Setting::getValue("PhoneNumberDropdown")];
        return $vars;
    }
    ...
    public function save($data)
    {
        ...
        $registrar->load("enom");
        $registrar->activate(["Username" => $enomUsername, "Password" => $enomPassword]);
    }
}
