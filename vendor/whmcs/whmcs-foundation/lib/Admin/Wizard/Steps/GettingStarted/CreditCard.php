...
class CreditCard
{
    ...
    public function save($data)
    {
        ...
        $postfields = ["name" => $name, "companyname" => \WHMCS\Config\Setting::getValue("CompanyName"), "email" => $email, "address" => $address, "city" => $city, "state" => $state, "postcode" => $postcode, "country" => $country, "phone" => $phone, "checksum" => sha1(self::API_SECRET_KEY . md5($name) . md5($email))];
