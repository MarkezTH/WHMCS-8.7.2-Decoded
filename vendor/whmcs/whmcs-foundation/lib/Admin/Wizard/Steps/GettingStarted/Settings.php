...
class Settings
{
    public function getTemplateVariables()
    {
        ...
        if (in_array($companyName, ["Company Name", ""])) {
        ...
        $vars["allowedCcSignupCountries"] = ["US"];
        return $vars;
    }
    ...
    public function save($data)
    {
        ...
        if ($logoUploaded) {
            try {
                ...
                $logoFileValidationFunctions = [".png" => "imagecreatefrompng", ".jpg" => "imagecreatefromjpeg"];
                ...
                if (isset($logoFileValidationFunctions[$fileExtension])) {
                    ...
                    if (function_exists($validationFunction)) {
                        ...
                        if (is_a($hImage, "GdImage") === true) {
                            $logoFileVerified = $hImage;
                        } else {
