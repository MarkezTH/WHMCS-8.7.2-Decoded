...
class Markdown extends \Michelf\MarkdownExtra
{
    ...
    {
        $this->span_gamut += ["doTextWithBreaks" => 100];
        $this->document_gamut += ["doHtmlPurifier" => 100];
        parent::__construct();
        $this->predef_urls = [];
        $this->predef_titles = [];
        $this->predef_abbr = [];
    ...
    protected function doHtmlPurifier($text)
    {
        ...
        $config->set("CSS.ForbiddenProperties", ["background-image"]);
    ...
    protected function _doAnchors_inline_callback($matches)
    {
        ...
        $result .= $targetClass . ">" . $link_text . "</a>";
    ...
    protected function _doLinkReplace_callback($matches)
    {
    ...
    protected function legacyAutoHyperLink($message)
    {
        ...
        return preg_replace_callback($regex, [$this, "_doLinkReplace_callback"], $message);
    }
