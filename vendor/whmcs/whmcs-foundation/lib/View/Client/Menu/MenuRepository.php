...
class MenuRepository
{
    ...
    {
        if (!in_array($sidebar, ["primarySidebar", "secondarySidebar"])) {
    ...
    public function primaryNavbar($firstName = "", $conditionalLinks = [])
    {
    ...
    public function secondaryNavbar($firstName = "", $conditionalLinks = [])
    {
    ...
    public function addContext($key = NULL, $value)
    {
        if (!is_null($key)) {
