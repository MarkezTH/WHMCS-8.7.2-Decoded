...
class Application extends \Symfony\Component\Console\Application
{
    ...
    {
        return new \Symfony\Component\Console\Input\InputDefinition([new \Symfony\Component\Console\Input\InputArgument("command", \Symfony\Component\Console\Input\InputArgument::REQUIRED, "The command to execute"), new \Symfony\Component\Console\Input\InputOption("--help", "-h", \Symfony\Component\Console\Input\InputOption::VALUE_NONE, "Display this help message"), new \Symfony\Component\Console\Input\InputOption("--verbose", "-v|vv|vvv", \Symfony\Component\Console\Input\InputOption::VALUE_NONE, "Increase the verbosity of messages: 1 for normal output, 2 for more verbose output and 3 for debug"), new \Symfony\Component\Console\Input\InputOption("--version", "-V", \Symfony\Component\Console\Input\InputOption::VALUE_NONE, "Display this application version"), new \Symfony\Component\Console\Input\InputOption("--ansi", "", \Symfony\Component\Console\Input\InputOption::VALUE_NONE, "Force ANSI output"), new \Symfony\Component\Console\Input\InputOption("--no-ansi", "", \Symfony\Component\Console\Input\InputOption::VALUE_NONE, "Disable ANSI output")]);
    }

    protected function getDefaultCommands()
    {
        $allCmds = [new Command\ListCommand(), new Command\HelpCommand()];
        $all = new Command\AllCommand();
        $allCmds[] = $all;
        $customCmds = [new Command\DoCommand(), new Command\SkipCommand()];
    ...
    protected function getCommandName(\Symfony\Component\Console\Input\InputInterface $input)
    {
        ...
        if (!$normalName && true !== $input->hasParameterOption(["--help", "-h"])) {
            return "all";
        }
        return $normalName;
    }
