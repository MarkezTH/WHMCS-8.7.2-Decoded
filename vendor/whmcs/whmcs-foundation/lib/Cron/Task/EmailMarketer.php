...
class EmailMarketer extends \WHMCS\Scheduling\Task\AbstractTask
{
    ...
    public function __invoke()
    {
        ...
        foreach ($emailRules as $emailRule) {
            ...
            $freeCycleKey = array_search("Free", $billingCycles);
            if ($freeCycleKey !== false) {
                $billingCycles[$freeCycleKey] = \WHMCS\Billing\Cycles::DISPLAY_FREE;
            }
