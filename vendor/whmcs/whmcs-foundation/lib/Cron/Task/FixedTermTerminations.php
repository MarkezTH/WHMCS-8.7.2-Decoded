...
class FixedTermTerminations extends \WHMCS\Scheduling\Task\AbstractTask
{
    ...
    protected $outputs = ["terminations" => ["defaultValue" => 0, "identifier" => "terminations", "name" => "Services Terminated"], "manual" => ["defaultValue" => 0, "identifier" => "manual", "name" => "Manual Terminations Required"], "action.detail" => ["defaultValue" => "", "identifier" => "action.detail", "name" => "Action Detail"]];
        ...
        while ($data = mysql_fetch_array($result)) {
            ...
            while ($data = mysql_fetch_array($result2)) {
                ...
                if ($moduleresult == "success") {
                    ...
                    $this->addFailure(["service", $serviceid, $moduleresult]);
                }
