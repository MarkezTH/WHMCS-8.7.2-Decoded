...
class MysqlCompat
{
    ...
    public function mysqlQuery($query, $pdo = NULL)
    {
        ...
        try {
            ...
            $returnStatementOn = ["select", "show", "alter", "create", "drop", "rename", "truncate"];
