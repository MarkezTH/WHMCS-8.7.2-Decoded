...
class Application extends AbstractBootstrap
{
    ...
    {
        return ["\\WHMCS\\Application\\Support\\Facades\\Auth" => "Auth", "\\WHMCS\\Billing\\Currency" => "Currency", "\\WHMCS\\Application\\Support\\Facades\\Log" => "Log", "\\WHMCS\\Application\\Support\\Facades\\Menu" => "Menu", "\\WHMCS\\Log\\Activity" => "ActivityLog", "\\WHMCS\\Application\\Support\\Facades\\Config" => "Config", "\\WHMCS\\Application\\Support\\Facades\\App" => "App", "\\WHMCS\\Application\\Support\\Facades\\Lang" => "Lang", "\\WHMCS\\Application\\Support\\Facades\\AdminLang" => "AdminLang", "\\WHMCS\\Application\\Support\\Facades\\Storage" => "Storage", "\\WHMCS\\Application\\Support\\Facades\\Hook" => "Hook", "\\WHMCS\\Application\\Support\\Facades\\HookMgr" => "HookMgr", "\\Firebase\\JWT\\JWT" => "JWT", "\\WHMCS\\ClientArea" => "WHMCS_ClientArea", "\\WHMCS\\Chart" => "WHMCSChart"];
    }
    ...
    public static function getSingletons()
    {
        return ["auth" => function () {
            ...
            $server = new \WHMCS\ApplicationLink\Server\Server($storage, ["use_openid_connect" => true]);
    ...
    {
        return ["\\WHMCS\\Log\\LogServiceProvider", "\\WHMCS\\Route\\RouteServiceProvider", "\\WHMCS\\Application\\ApplicationServiceProvider", "\\WHMCS\\Api\\ApiServiceProvider", "\\WHMCS\\Smarty\\SmartyServiceProvider", "\\WHMCS\\View\\ViewServiceProvider", "\\WHMCS\\ClientArea\\ClientAreaServiceProvider", "\\WHMCS\\MarketConnect\\MarketConnectServiceProvider", "\\WHMCS\\Cart\\CartServiceProvider", "\\WHMCS\\Authentication\\Remote\\ServiceProvider", "\\WHMCS\\File\\StorageServiceProvider", "\\WHMCS\\User\\Validation\\UserValidationServiceProvider", "WHMCS\\Hook\\HookServiceProvider", "WHMCS\\Payment\\PaymentServiceProvider"];
    }
}
