...
abstract class AbstractMigrationProcessor implements MigrationProcessorInterface
{
    ...
    protected $objectsToMigrate = [];
    protected $migratedObjects = [];
    ...
    public function __construct($assetType)
    {
        ...
        $this->migrationProgress = \WHMCS\File\Migration\FileAssetMigrationProgress::firstOrNew(["asset_type" => $this->assetType]);
