...
{
    private static $processorTypeMap = ["local-local" => "WHMCS\\File\\Migration\\Processor\\LocalToLocalMigrationProcessor", "local-s3" => "WHMCS\\File\\Migration\\Processor\\LocalToS3MigrationProcessor", "s3-local" => "WHMCS\\File\\Migration\\Processor\\S3ToLocalMigrationProcessor", "s3-s3" => "WHMCS\\File\\Migration\\Processor\\S3ToS3MigrationProcessor"];
