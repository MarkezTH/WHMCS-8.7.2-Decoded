...
class ComposerUpdate
{
    ...
    private $coreVersion = "";
    private $allowedCoreStabilityTiers = [];
    ...
    {
        $tiers = [ComposerJson::STABILITY_STABLE, ComposerJson::STABILITY_RC, ComposerJson::STABILITY_BETA];
    ...
    public function setAllowedCoreStabilityTiers($value)
    {
