...
class Installer
{
    ...
    public function persistSystemUrl()
    {
    ...
    public function performNonSeedIncrementalChange($settings = [], $localStorage = [])
    {
    ...
    protected function createInitialStorageConfigurations($localStorage = [])
    {
    ...
    public function setSystemUrl($self, $url)
    {
        $prefix = "http";
