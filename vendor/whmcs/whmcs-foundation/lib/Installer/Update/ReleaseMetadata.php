...
class ReleaseMetadata
{
    ...
    public function setFromPackageMetadata($productVersion, $packageMetadata)
    {
        $this->clean();
    ...
    public function save()
    {
        ...
        $metadata = ["productVersion" => $this->productVersion, "releaseNotesUrl" => $this->releaseNotesUrl, "changeLogUrl" => $this->changeLogUrl];
