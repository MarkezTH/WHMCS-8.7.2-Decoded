...
class Version790beta1 extends IncrementalVersion
{
    public function __construct(\WHMCS\Version\SemanticVersion $version)
    {
        ...
        $oldWhatsNewImages = ["date-picker.png", "multiple-credit-cards.png", "server-sync-tool.png", "stripe-elements.png", "stripe-logo.png", "time-based-tokens.png"];
