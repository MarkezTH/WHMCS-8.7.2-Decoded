...
{
    protected $updateActions = ["removeHtAccessTxt", "createDefaultNotificationEmailTemplate", "removeOldApplicationLink"];

    protected function removeHtAccessTxt()
    {
        $knownShippedHashes = ["58e84cee556969309b8c7146b3edc5a2", "2ad298cf3b5973aaa8a2b3931ecc6e97", "4d2513272efefa886601253efd393404"];
    ...
    protected function removeOldApplicationLink()
    {
        ...
        foreach ($servers as $server) {
            $queue->add($server->module_name . ".link.cleanup", "WHMCS\\ApplicationLink\\Provision", "cleanup", [$server->module_name], 0, true);
        }
        return $this;
    }
}
