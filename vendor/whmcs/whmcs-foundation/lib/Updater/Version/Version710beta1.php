...
{
    protected $updateActions = ["updateCronTasksNextDue", "migrateLookupProviderSettings", "removeLegacyAdminWidgets"];
    ...
    {
        $existingProviderSettings = \WHMCS\Database\Capsule::table("tblconfiguration")->where("setting", "like", "domainLookup\\_%")->get()->all();
        foreach ($existingProviderSettings as $existingProviderSetting) {
            ...
            $newSetting = \WHMCS\Domains\DomainLookup\Settings::firstOrNew(["registrar" => $registrar, "setting" => $settingParts[2]]);
            if ($value == "") {
                $value = 0;
            } else {
    ...
    {
        $widgetFilesToRemove = ["activity_log.php", "admin_activity.php", "calendar.php", "client_activity.php", "getting_started.php", "income_forecast.php", "income_overview.php", "my_notes.php", "network_status.php", "open_invoices.php", "orders_overview.php", "system_overview.php", "tickets_overview.php", "todo_list.php", "whmcs_news.php"];
