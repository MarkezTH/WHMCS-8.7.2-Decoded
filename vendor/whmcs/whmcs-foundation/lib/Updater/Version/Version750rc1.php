...
{
    protected $updateActions = ["checkForSpacesInAdminUsername", "renameMergeFieldsInUpcomingDomainRenewalNoticeEmailTemplate"];
    ...
    protected function renameMergeFieldsInUpcomingDomainRenewalNoticeEmailTemplate()
    {
        ...
        if ($template) {
            ...
            $message = str_replace(["domain_renewal_link", "domains_manage_link"], ["domain_renewal_url", "domains_manage_url"], $message);
