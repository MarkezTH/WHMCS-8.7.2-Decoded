...
{
    protected $updateActions = ["migrateOpenIDValues", "createTicketNotificationEmail"];

    public function migrateOpenIDValues()
    {
        $rowsToMigrate = \WHMCS\Database\Capsule::table("tbloauthserver_clients")->select(["id", "redirect_uri", "grant_types"])->get()->all();
