...
{
    protected $updateActions = ["newEmailHeader", "newEmailCss", "newEmailFooter", "updateCreateTicketNotificationEmail", "removeOldAdminSupportEmailTemplates"];
    ...
    {
        \WHMCS\Database\Capsule::table("tblemailtemplates")->whereIn("name", ["Support Ticket Created", "Support Ticket Department Reassigned", "Support Ticket Flagged", "Support Ticket Response"])->where("type", "=", "admin")->delete();
        return $this;
    }
}
