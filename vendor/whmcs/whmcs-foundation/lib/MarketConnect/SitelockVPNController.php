...
class SitelockVPNController extends AbstractController
{
    protected $serviceName = MarketConnect::SERVICE_SITELOCKVPN;
    protected $langPrefix = "sitelockvpn";
    ...
    public function index(\WHMCS\Http\Message\ServerRequest $request)
    {
        ...
        if ($emulated) {
            ...
            $pricingFeed = $feed->getTerms(Promotion\Service\SitelockVPN::SITELOCKVPN_STANDARD);
        }
