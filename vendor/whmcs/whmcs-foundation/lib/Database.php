...
class Database implements Database\DatabaseInterface
{
    ...
    protected function capsuleFactory()
    {
        ...
        $config = ["driver" => "mysql", "host" => $this->getHostname(), "database" => $this->getDatabaseName(), "username" => $this->getUsername(), "password" => $this->getPassword(), "charset" => $this->getCharacterSet(), "collation" => $this->getCollationFromCharacterSet($this->getCharacterSet()), "prefix" => ""];
