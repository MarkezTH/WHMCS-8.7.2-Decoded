...
class History extends \WHMCS\Model\AbstractModel
{
    ...
    protected $booleans = ["completed"];
    protected $columnMap = ["invoiceId" => "invoice_id", "transactionId" => "transaction_id", "remoteStatus" => "remote_status", "additionalInformation" => "additional_information", "currencyId" => "currency_id"];
    protected $fillable = ["invoice_id", "gateway", "transaction_id"];
