...
echo "</p>\n<br/>\n<div class=\"row\">\n    <div class=\"col-sm-4\">\n        <strong>";
echo AdminLang::trans("phpCompatUtil.currentLoaderVersion");
echo ":</strong>\n        <span class=\"ioncube-encoder-version\">\n            ";
echo $localLoaderVersion instanceof WHMCS\Version\SemanticVersion ? $localLoaderVersion->getVersion() : "?";
...
if ($lastScanned instanceof WHMCS\Carbon) {
    echo "                    ";
    echo $lastScanned->toAdminDateTimeFormat();
    echo "                ";
} else {
    echo "                    ";
    echo AdminLang::trans("phpCompatUtil.never");
    echo "                ";
}
