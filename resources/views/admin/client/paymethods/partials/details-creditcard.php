...
if (isset($payMethod) && $payMethod && $payMethod->payment instanceof WHMCS\Payment\PayMethod\Adapter\CreditCard) {
...
echo "</span>\n        </div>\n    </div>\n    ";
if (isset($payMethodType) && $payMethodType === "RemoteCreditCard") {
...
echo routePath("admin-client-paymethods-decrypt-cc-data", $client->id, $payMethod->id ?? NULL);
