...
$this->insert("shared/configuration-promotions", ["serviceOffering" => $serviceOffering, "service" => $service, "mcServiceSlug" => $mcServiceSlug, "isActivationForm" => true]);
echo "        </div>\n        <div id=\"activate-advanced-finish\" class=\"tab-pane\" role=\"tabpanel\">\n            ";
$this->insert("shared/configuration-general-settings", ["serviceOffering" => $serviceOffering, "service" => $service, "mcServiceSlug" => $mcServiceSlug, "isActivationForm" => true]);
