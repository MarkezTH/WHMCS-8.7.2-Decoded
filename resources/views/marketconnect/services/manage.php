...
$this->insert("shared/configuration-products", ["currency" => $currency, "billingCycles" => $billingCycles, "products" => $products, "serviceTerms" => $serviceTerms, "isActivationForm" => false]);
