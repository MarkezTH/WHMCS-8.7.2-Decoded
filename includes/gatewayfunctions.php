...
function getRecurringBillingValues($invoiceId)
{
    ...
    if ($convertTo) {
        ...
        $firstPaymentAmount = convertCurrency($firstPaymentAmount, $currency["id"], $convertTo, null);
        $recurringAmount = convertCurrency($recurringAmount, $currency["id"], $convertTo, null);
    }
