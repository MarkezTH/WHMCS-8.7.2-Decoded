...
{
    $configarray = ["FriendlyName" => ["Type" => "System", "Value" => "IP.Pay"], "terminalid" => ["FriendlyName" => "Terminal ID", "Type" => "text", "Size" => "25", "Description" => "Your Terminal ID assigned by IPpay"], "testmode" => ["FriendlyName" => "Test Mode", "Type" => "yesno"]];
    return $configarray;
}
