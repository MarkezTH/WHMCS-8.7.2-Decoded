        ...
        default:
            ...
            if (!$txn_type && $payment_status === "Refunded" && $reasonCode === "buyer_complaint") {
                ...
                if ($paypalcurrencyid != $currency["id"]) {
                    $mc_gross = convertCurrency($mc_gross, $currency["id"], $paypalcurrencyid, 1);
                    $mc_fee = convertCurrency($mc_fee, $currency["id"], $paypalcurrencyid, 1);
                }
            ...
            if ($invoiceid) {
                ...
                if ($paypalcurrencyid != $currency["id"]) {
                    ...
                    $grossExpected = convertCurrency($total, $currency["id"], $paypalcurrencyid, 1);
