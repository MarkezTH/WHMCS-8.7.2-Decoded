...
{
    return ["DisplayName" => "PayPal Pro Reference Payments", "APIVersion" => "1.1", "TokenWorkflow" => true];
}

function paypalpaymentsproref_config()
{
    $configarray = ["FriendlyName" => ["Type" => "System", "Value" => "PayPal Pro Reference Payments"], "apiusername" => ["FriendlyName" => "API Username", "Type" => "text", "Size" => "30"], "apipassword" => ["FriendlyName" => "API Password", "Type" => "text", "Size" => "30"], "apisignature" => ["FriendlyName" => "API Signature", "Type" => "text", "Size" => "30"], "processorid" => ["FriendlyName" => "Processor ID", "Type" => "text", "Size" => "20", "Description" => "Cardinal 3D Secure Details"], "merchantid" => ["FriendlyName" => "Merchant ID", "Type" => "text", "Size" => "20"], "transpw" => ["FriendlyName" => "Transaction PW", "Type" => "text", "Size" => "20"], "sandbox" => ["FriendlyName" => "Sandbox", "Type" => "yesno"]];
    return $configarray;
}
...
function paypalpaymentsproref_capture($params)
{
    ...
    return ["status" => "error", "rawdata" => $resArray];
}
...
function paypalpaymentsproref_refund($params)
{
    ...
    if (strtoupper($resultsarray["ACK"]) == "SUCCESS") {
        return ["status" => "success", "rawdata" => $resultsarray, "transid" => $resultsarray["REFUNDTRANSACTIONID"]];
    }
