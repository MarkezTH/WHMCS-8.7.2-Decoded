...
{
    return ["DisplayName" => "Optimal Payments", "APIVersion" => "1.1"];
}

function optimalpayments_config()
{
    $configarray = ["FriendlyName" => ["Type" => "System", "Value" => "Optimal Payments"], "accountnumber" => ["FriendlyName" => "Account Number", "Type" => "text", "Size" => "20"], "merchantid" => ["FriendlyName" => "Merchant ID", "Type" => "text", "Size" => "20"], "merchantpw" => ["FriendlyName" => "Merchant Password", "Type" => "text", "Size" => "20"], "testmode" => ["FriendlyName" => "Test Mode", "Type" => "yesno"]];
    return $configarray;
}
...
function optimalpayments_capture($params)
{
    ...
    $xmlData = $xmlData["CCTXNRESPONSEV1"];
    if ($xmlData["CODE"] == "0") {
        return ["status" => "success", "transid" => $xmlData["txnNumber"], "rawdata" => $xmlData];
    }
    return ["status" => "declined", "rawdata" => $xmlData];
}
