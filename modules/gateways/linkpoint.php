...
{
    $configarray = ["FriendlyName" => ["Type" => "System", "Value" => "LinkPoint"], "storenumber" => ["FriendlyName" => "Store Number", "Type" => "text", "Size" => "20"], "keyfile" => ["FriendlyName" => "Key File", "Type" => "text", "Size" => "50", "Description" => "Full path to file eg. /home/username/xxxxxx.pem"], "testmode" => ["FriendlyName" => "Test Mode", "Type" => "yesno"]];
    return $configarray;
}
...
function linkpoint_capture($params)
{
    ...
    if ($result["r_message"] === "APPROVED") {
        return ["status" => "success", "transid" => $result["r_ordernum"], "rawdata" => $desc];
    }
