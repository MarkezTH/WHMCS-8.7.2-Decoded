...
function nochex_activate()
{
    ...
    defineGatewayField("nochex", "yesno", "hide", "", "Hide Details", "0", "Check to stop customer details being repeated on Nochex payment page");
    defineGatewayField("nochex", "yesno", "testmode", "", "Test Mode", "0", "Check to enable test transaction mode");
}
