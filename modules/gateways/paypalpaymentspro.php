...
if (WHMCS\Module\GatewaySetting::getValue("paypalpaymentspro", "processorid")) {
...
{
    return ["DisplayName" => "PayPal Website Payments Pro", "APIVersion" => "1.1"];
}

function paypalpaymentspro_config()
{
    $configarray = ["FriendlyName" => ["Type" => "System", "Value" => "PayPal Website Payments Pro"], "apiusername" => ["FriendlyName" => "API Username", "Type" => "text", "Size" => "20"], "apipassword" => ["FriendlyName" => "API Password", "Type" => "text", "Size" => "20"], "apisignature" => ["FriendlyName" => "API Signature", "Type" => "text", "Size" => "20"], "processorid" => ["FriendlyName" => "Processor ID", "Type" => "text", "Size" => "20", "Description" => "Cardinal 3D Secure Details"], "merchantid" => ["FriendlyName" => "Merchant ID", "Type" => "text", "Size" => "20"], "transpw" => ["FriendlyName" => "Transaction PW", "Type" => "text", "Size" => "20"], "sandbox" => ["FriendlyName" => "Test Mode", "Type" => "yesno"]];
    return $configarray;
}
...
function paypalpaymentspro_capture($params, $auth = "")
{
    ...
    if ($ack == "SUCCESS" || $ack == "SUCCESSWITHWARNING") {
        return ["status" => "success", "transid" => $resArray["TRANSACTIONID"], "rawdata" => $resArray];
    }
    return ["status" => "declined", "rawdata" => $resArray, "declinereason" => $resArray["RESPMSG"]];
}
