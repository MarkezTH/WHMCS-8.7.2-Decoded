...
{
    global $CONFIG;
    $configarray = ["FriendlyName" => ["Type" => "System", "Value" => "WorldPay"], "installationid" => ["FriendlyName" => "Installation ID", "Type" => "text", "Size" => "20", "Description" => "Enter your WorldPay Installation ID"], "prpassword" => ["FriendlyName" => "Payment Response Password", "Type" => "text", "Size" => "20", "Description" => "Enter your WorldPay Payment Response Password used in Callback Validations (Optional)"], "testmode" => ["FriendlyName" => "Test Mode", "Type" => "yesno"]];
    return $configarray;
}
