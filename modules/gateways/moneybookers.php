...
{
    return ["FriendlyName" => ["Type" => "System", "Value" => "Skrill Hosted Payment Solution"], "merchantemail" => ["FriendlyName" => "Merchant Email", "Type" => "text", "Size" => "50", "Description" => "The email address used to identify you to Skrill"], "secretword" => ["FriendlyName" => "Secret Word", "Type" => "text", "Size" => "30", "Description" => "Must match what is set in the Merchant Tools section of your Skrill Account"]];
}
