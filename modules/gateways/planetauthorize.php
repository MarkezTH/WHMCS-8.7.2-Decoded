...
{
    $configarray = ["FriendlyName" => ["Type" => "System", "Value" => "PlanetAuthorize"], "submissionurl" => ["FriendlyName" => "Submission URL", "Type" => "text", "Size" => "80", "Value" => "https://secure.planetauthorizegateway.com/gateway/transact.dll", "Description" => "Any Auth.net Emulation URL"], "loginid" => ["FriendlyName" => "Login ID", "Type" => "text", "Size" => "20"], "transkey" => ["FriendlyName" => "Transaction Key", "Type" => "text", "Size" => "20"], "testmode" => ["FriendlyName" => "Test Mode", "Type" => "yesno"]];
    return $configarray;
}
