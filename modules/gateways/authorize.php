...
{
    return ["FriendlyName" => ["Type" => "System", "Value" => "Authorize.net"], "loginid" => ["FriendlyName" => "Login ID", "Type" => "text", "Size" => "20"], "transkey" => ["FriendlyName" => "Transaction Key", "Type" => "password", "Size" => "20"], "testmode" => ["FriendlyName" => "Test Mode", "Type" => "yesno"]];
}
...
function authorize_capture($params)
{
    ...
    switch ($auth->process()) {
        case 1:
            ...
            break;
        case 2:
            return ["status" => "declined", "rawdata" => $auth->dump_response(), "declinereason" => $auth->get_response_reason_text()];
            break;
        default:
            return ["status" => "error", "rawdata" => $auth->dump_response(), "declinereason" => $auth->get_response_reason_text()];
    }
}
