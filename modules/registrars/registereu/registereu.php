...
{
    $configarray = ["FriendlyName" => ["Type" => "System", "Value" => "Register.eu"], "Username" => ["Type" => "text", "Size" => "20", "Description" => "Enter your username here"], "Password" => ["Type" => "password", "Size" => "20", "Description" => "Enter your password here"], "TestMode" => ["Type" => "yesno"]];
    return $configarray;
}

function registereu_GetNameservers($params)
{
    return ["ns1" => "Enter value to change", "ns2" => "Enter value to change"];
}
