...
{
    $configarray = ["FriendlyName" => ["Type" => "System", "Value" => "Affordable Domains"], "Username" => ["Type" => "text", "Size" => "20", "Description" => "Enter your AffordableDomains.co.nz Username here"], "Password" => ["Type" => "password", "Size" => "20", "Description" => "Enter your Account Password here"], "TestMode" => ["Type" => "yesno"]];
    return $configarray;
}
...
function affordabledomains_connect_server($url, $postfields)
{
    ...
    logModuleCall("affordabledomains", $action, $postfields, $data, "", [$postfields["txtLoginUname"], $postfields["txtLoginPwd"]]);
    return $data;
}
