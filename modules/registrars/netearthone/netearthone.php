...
{
    return ["DisplayName" => "NetEarthOne", "APIVersion" => "1.1", "NonLinearRegistrationPricing" => true];
}
...
function netearthone_CheckAvailability($params)
{
    return resellerclub_CheckAvailability($params);
}

function netearthone_GetDomainSuggestions($params)
{
    return resellerclub_GetDomainSuggestions($params);
}

function netearthone_GetPremiumPrice($params)
{
...
function netearthone_GetDomainInformation($params)
{
    return resellerclub_GetDomainInformation($params);
}

function netearthone_ResendIRTPVerificationEmail($params)
{
    return resellerclub_ResendIRTPVerificationEmail($params);
}

function netearthone_GetTldPricing($params)
{
    return resellerclub_GetTldPricing($params);
}

function netearthone_AdditionalDomainFields($params)
{
