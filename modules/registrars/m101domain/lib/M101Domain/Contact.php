...
class Contact
{
    ...
    public function normalize()
    {
        ...
        $required = ["email" => "Email Address", "first_name" => "First Name", "last_name" => "Last Name", "address1" => "Address", "city" => "City", "country" => "Country", "phone" => "Phone"];
        $errors = [];
        ...
        if (0 < count($errors)) {
            throw new Exception\Error("Failed to Create Contact: " . implode(", ", $errors));
        }
    }
