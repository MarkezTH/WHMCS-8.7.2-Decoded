...
{
    return ["DisplayName" => "StarGate/UK2", "APIVersion" => "1.1", "NonLinearRegistrationPricing" => true];
}
...
function stargate_CheckAvailability($params)
{
    return resellerclub_CheckAvailability($params);
}

function stargate_GetDomainSuggestions($params)
{
    return resellerclub_GetDomainSuggestions($params);
}

function stargate_GetPremiumPrice($params)
{
...
function stargate_GetDomainInformation($params)
{
    return resellerclub_GetDomainInformation($params);
}

function stargate_ResendIRTPVerificationEmail($params)
{
    return resellerclub_ResendIRTPVerificationEmail($params);
}

function stargate_GetTldPricing($params)
{
    return resellerclub_GetTldPricing($params);
}

function stargate_AdditionalDomainFields($params)
{
