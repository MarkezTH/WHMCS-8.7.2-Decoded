...
{
    $configarray = ["Template Name" => ["Type" => "text", "Size" => "30"], "Plan Name" => ["Type" => "text", "Size" => "30"], "Dedicated IP" => ["Type" => "yesno", "Description" => "Check to auto assign next available dedicated IP"]];
    return $configarray;
}
