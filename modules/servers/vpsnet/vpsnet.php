...
function vpsnet_ConfigOptions($params)
{
    ...
    if ($verifyauth["success"] != "1") {
        ...
        $configarray = ["Number of Nodes" => ["Type" => "text", "Size" => "5"], "Cloud/Template" => ["Type" => "dropdown", "Options" => $cloudtemplate], "Enable Backups" => ["Type" => "yesno", "Description" => "Check to enable backups"], "Rsync Backups" => ["Type" => "yesno", "Description" => "Check to enable"], "R1Soft Backups" => ["Type" => "yesno", "Description" => "Check to enable"], "" => ["Type" => "x", "Description" => ""]];
        return $configarray;
    }
}
