...
function websitepanel_ConfigOptions()
{
    ...
    $configarray = ["Package Name" => ["Type" => "text", "Size" => "25", "Description" => $soap_check_msg], "Web Space Quota" => ["Type" => "text", "Size" => "5", "Description" => "MB"], "Bandwidth Limit" => ["Type" => "text", "Size" => "5", "Description" => "MB"], "PlanID" => ["Type" => "text", "Size" => "3", "Description" => " * DNP Hosting Plan ID"], "Parent SpaceID" => ["Type" => "text", "Size" => "3", "Description" => "* SpaceID that all accounts are created under"], "Enterprise Server Port" => ["Type" => "text", "Size" => "5", "Description" => "* Required"], "Different Portal URL" => ["Type" => "yesno", "Description" => "Check if portal address is different to server address"], "Portal URL" => ["Type" => "text", "Size" => "25", "Description" => "Portal URL, with http://, no trailing slash"], "Send DNP Account Summary email" => ["Type" => "yesno", "Description" => "Check to send DNP Account Summary"], "Send DNP Hosting Space Summary email" => ["Type" => "yesno", "Description" => "Check to send Hosting Space Summary"], "Create Mail account" => ["Type" => "yesno", "Description" => "Check to create mail account"], "Create FTP account" => ["Type" => "yesno", "Description" => "Check to create FTP account"], "Temporary domain" => ["Type" => "yesno", "Description" => "Check to create a temp domain"], "HTML email" => ["Type" => "yesno", "Description" => "Check enable HTML email from DNP"], "Create Website" => ["Type" => "yesno", "Description" => "Check to create Website"], "Count Bandwidth/Diskspace" => ["Type" => "yesno", "Description" => "Check to update diskpace/bandwidth in WHMCS"]];
    return $configarray;
}
