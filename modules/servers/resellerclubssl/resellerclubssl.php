...
function resellerclubssl_SSLStepOne($params)
{
    ...
    if ($params["remoteid"] && !strpos($params["certtype"], "|")) {
        ...
        if ($params["remoteid"]) {
            ...
            if ((bool) $certificateData["actioncompleted"]) {
                $sslOrder->completionDate = WHMCS\Carbon::now()->toDateTimeString();
                $sslOrder->status = WHMCS\Service\Ssl::STATUS_COMPLETED;
            } else {
                $sslOrder->completionDate = "0000-00-00 00:00:00";
...
function resellerclubssl_CustomActions($CustomActionCollection, $params)
{
    ...
    $customActionCollection->add(WHMCS\Module\Server\CustomAction::factory("resellerclubssl", "sslconfigurenow", function ($sslCertificate) {
