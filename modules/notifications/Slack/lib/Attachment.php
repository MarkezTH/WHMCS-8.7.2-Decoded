...
class Attachment
{
    ...
    {
        $attachment = ["fallback" => $this->fallback, "color" => $this->color, "pretext" => $this->pretext, "title" => $this->title, "title_link" => $this->title_link, "text" => $this->text, "footer" => $this->footer, "footer_icon" => $this->footer_icon];
