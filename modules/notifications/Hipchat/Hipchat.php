...
class Hipchat implements \WHMCS\Module\Contracts\NotificationModuleInterface
{
    ...
    {
        return ["api_token" => ["FriendlyName" => "API Token", "Type" => "text", "Description" => "Requires a HipChat API V2 User Token. To create one, navigate to Account Settings > API Access. The token requires the View Room and Send Notification scopes."], "api_url" => ["FriendlyName" => "API URL", "Type" => "text", "Placeholder" => static::HOSTED_API_URL, "Description" => "If using HipChat Server Edition, enter the URL to your self-hosted Hipchat Instance."]];
    }
